...
<!--   <nav  class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      <a style="color: black" class="navbar-brand js-scroll-trigger" href="<?=base_url()?>index.php/cpanel" >আমরা ৯০ শতকের</a>
...
<input type="hidden" name="hidEx1" id="hidEx1"/>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="form-group input-group">
          <textarea class="form-control" placeholder="TextDetails" name="textDetails" id="textDetails" type="text"></textarea>
        </div>
      </div> 
      ...
      <div class="row">
            <div class="col-xs-12 col-md-6 col-md-offset-3">
              <input type="button" onClick="validateText('frmcpanel',0,'addText90days')" class="" value="Submit"/>
            </div>
  ...
  <div class="col-xs-8 col-md-12 ">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title text-center" style="font-size:20px;font-weight: bold;padding:20px;"></h3>
      </div>
      <div class="panel-body">
        <table class="col-xs-8 col-md-12  table-responsive table table-striped table-bordered table-hover" 
