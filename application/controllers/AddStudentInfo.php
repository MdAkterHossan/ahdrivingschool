...
class AddStudentInfo extends CI_Controller {
	...
	public function index(){	
		...
		$data['message']= '';
		$data['studentinfo']  = $this->mix_model->getstudentInformation();
		$this->load->view('header_view',$data);
		$this->load->view('menu_view',$data);
		$this->load->view('addStudentInfo_view',$data);
	...
	public function addNewStudentInfo() {
		...
		$res = $this->mix_model->insertIntoStudentInfo($_REQUEST);
		$this->load->view('header_view',$data);
		$this->load->view('menu_view',$data);
		$this->load->view('addStudentInfo_view',$data);
